ITEM.name = "Social Skill Book"
ITEM.description = "A worn book of etiquette and hard-learned people skills. The binding is nearly gone - studying it closely will likely finish it off."
...
ITEM.functions.Read = {
	...
	multiOptions = function(itemTable, client)
		...
		for _, skill in ipairs(GetSkillsInCategory("Social")) do
	...
	OnRun = function(item, data)
		...
		if (!skillData or skillData.category != "Social") then
			return false
		end
