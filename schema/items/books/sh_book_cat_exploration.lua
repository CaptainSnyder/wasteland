ITEM.name = "Exploration Skill Book"
ITEM.description = "A water-warped guide to surviving the wastes beyond the walls. It's falling apart at the spine - reading it through will likely be its last use."
...
ITEM.functions.Read = {
	...
	multiOptions = function(itemTable, client)
		...
		for _, skill in ipairs(GetSkillsInCategory("Exploration")) do
	...
	OnRun = function(item, data)
		...
		if (!skillData or skillData.category != "Exploration") then
			return false
		end
