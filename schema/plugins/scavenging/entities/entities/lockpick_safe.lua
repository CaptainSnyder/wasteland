ENT.Type = "anim"
ENT.PrintName = "Lockpick Safe"
ENT.Category = "Wasteland - Scavenging"
ENT.Spawnable = true
ENT.AdminOnly = true

ENT.SkillID = "lockpicking"
ENT.SearchCooldown = 21600 -- 6 hours before this safe can be searched again
...
if (SERVER) then
    function ENT:Initialize()
        self:SetModel("models/models/fallout/genericsafe.mdl")
    ...
    function ENT:Use(activator, caller)
        ...
        if (self.nextUse and self.nextUse > CurTime()) then
            activator:Notify("This safe has already been cleaned out for now. Try again in " .. FormatSearchCooldown(self.nextUse - CurTime()) .. ".")
            return
        end
