ITEM.name = "Bottle of Tarcola"
ITEM.model = Model("models/silver/outbreak/items/item_tarcola.mdl")
ITEM.description = "[COMMON] A bottle of Tarcola. Impossibly, the fizz never went flat."
ITEM.width = 1
ITEM.height = 1
