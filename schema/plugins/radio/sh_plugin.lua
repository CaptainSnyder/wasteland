...
local function endChatter(listener)
	timer.Simple(1, function()
		...
		listener:EmitSound("silver/contact_"..math.random(2, 7)..".wav", math.random(60, 70), math.random(80, 120))
	end)
end
...
ix.chat.Register("radio", {
	...
	CanSay = function(self, speaker, text)
		...
		if (freq) then
			CURFREQ = freq
			speaker:EmitSound("silver/contact_"..math.random(2, 7)..".wav", math.random(50, 60), math.random(80, 120))
		else
