...
-- false: only weapons described in sh_tfa_weps.lua get items. Wasteland hand-writes its weapon
-- items so they match the tiers in schema/docs/economy.md; auto-generation would price every
-- weapon at a flat 4000 and sweep in every tfa_ class on the server.
