...
ix.config.Add("generateAttachmentItems(Tfa)", true, "Whether or not TFA attachments will have items created automatically. This can take a while with a lot of packs.", function(oldValue, newValue)
...
ix.command.Add("TFAGenWeapons", {
	description = "Generates items for all TFA weapons.",
	superAdminOnly = true,
	OnRun = function(self, client)
		ix.tfa.GenerateWeapons()
		RunConsoleCommand("spawnmenu_reload")
		return "TFA weapon items have been generated."
	end
})
